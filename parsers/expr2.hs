-- https://github.com/llcawthorne/thinking-functionally-with-haskell/blob/master/Chap11/Parsing.lhs
...
instance Applicative Parser where
  ...
  f <*> a = Parser (\cs ->
    concat [apply (fmap fn a) cs' | (fn, cs') <- apply f cs]) -- 本行中原为parse替换成了apply
